    ...
    class SamofinansirajuciStudent extends Student{
        ...
        */
        ...
        public function __construct2($i,$ob,$oc,$pb){
            ...
            elseif($pb<35 && $ob>=265 && ($pb+$ob)<=300){ //>=265 umesto >265, u suprotnom sa 265 osvojenih mogu da prijavim samo 35, ali ne i 34,33 itd.
                $this->prijavljeniESPB=$pb;
            }
            else{
                $this->prijavljeniESPB=0;
        ...
        */
        ...
        public function setOsvojeniESPBopsti($ob){
            ...
            }//ovde nije obezbedjeno da se ne dodje u slucaj da npr. $osvojene neko sa strane podesi na <265, a $prijavljeni ostanu na 15, ali priroda zadatka je takva da $osvojeni ne bi trebalo da se menjaju
        }
